...
var common = require('../util/common'); //引入API工具类js
...
var smsService = {
    ...
    send: function(smsPara, withCheck, callback) {
        ...
        common.wrapSystemCategory(queryObj, smsPara.systemCategory);
        //查询配置
        APIUtil.DBFindOne(SmsConfig, {
            ...
            if (withCheck) {
                smsService.checkSend({
                    ...
                    systemCategory: smsPara.systemCategory
    ...
    checkSend: function(smsInfoObj, smsConfig, callback) {
        ...
        common.wrapSystemCategory(loc_query, smsInfoObj.systemCategory);
     ...
     * @param callback
     */
    resend: function(params, callback) {
        let smsId = params.smsId;
        SmsInfo.findById(smsId, function(err, smsInfo) {
            ...
            common.wrapSystemCategory(loc_smsParam, params.systemCategory);
            //发送短信
     ...
     * @param callback
     */
    checkAuth: function(params, callback) {
